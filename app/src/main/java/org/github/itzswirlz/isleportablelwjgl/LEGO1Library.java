...
public class LEGO1Library extends org.github.itzswirlz.isleportablelwjgl.LegoOneConfig {
    static { Loader.load(); }
...
@NoOffset public static class AnimState extends LegoState {
	...
	public native @Cast("MxResult") boolean Serialize(LegoStorage p_storage); // vtable+0x1c
...
@NoOffset public static class LegoAnimationManager extends MxCore {
	...
	public static class Character extends Pointer {
		...
		public native @ByRef undefined m_unk0x06(); public native Character m_unk0x06(undefined setter); // 0x06 (unused?)
	...
	public native @Cast("MxResult") boolean Tickle();               // vtable+0x08
	...
	public native @Cast("MxResult") boolean LoadWorldInfo(@ByVal World p_worldId);
	...
	public native @Cast("MxResult") boolean ReadAnimInfo(LegoStorage p_storage, AnimInfo p_info);
	public native @Cast("MxResult") boolean ReadModelInfo(LegoStorage p_storage, ModelInfo p_info);
	...
	public native @Cast("MxResult") boolean StartEntityAction(@ByRef MxDSAction p_dsAction, LegoEntity p_entity);
	public native @Cast("MxResult") boolean FUN_10060dc0(
	...
	public native @Cast("MxResult") boolean FUN_10064670(Vector3 p_position);
	public native @Cast("MxResult") boolean FUN_10064740(Vector3 p_position);
	public native @Cast("MxResult") boolean FUN_10064880(@Cast("const char*") BytePointer p_name, @Cast("MxS32") int p_unk0x0c, @Cast("MxS32") int p_unk0x10);
	public native @Cast("MxResult") boolean FUN_10064880(String p_name, @Cast("MxS32") int p_unk0x0c, @Cast("MxS32") int p_unk0x10);
...
@NoOffset public static class LegoBuildingManager extends MxCore {
	...
	public native @Cast("MxResult") boolean Write(LegoStorage p_storage);
	public native @Cast("MxResult") boolean Read(LegoStorage p_storage);
	...
	public native @Cast("MxResult") boolean DetermineBoundaries();
...
@NoOffset public static class LegoGameState extends Pointer {
	...
	@NoOffset public static class Username extends Pointer {
		...
		public native @Cast("MxResult") boolean Serialize(LegoStorage p_storage);
...
// #endif
	...
	public native @Cast("MxResult") boolean Save(@Cast("MxULong") long arg0);
	public native @Cast("MxResult") boolean DeleteState();
	public native @Cast("MxResult") boolean Load(@Cast("MxULong") long arg0);

	public native void SerializePlayersInfo(@Cast("MxS16") short p_flags);
	public native @Cast("MxResult") boolean AddPlayer(@ByRef Username p_player);
...
@NoOffset public static class LegoOmni extends MxOmni {
	...
	public native @Cast("MxResult") boolean Create(@ByRef MxOmniCreateParam p_param);                                        // vtable+0x18
	public native void Destroy();                                                                     // vtable+0x1c
	public native @Cast("MxResult") boolean Start(MxDSAction p_dsAction);                                             // vtable+0x20
	...
	public native @Cast("MxResult") boolean RegisterWorlds();
	...
	public native LegoSoundManager GetSoundManager();
	...
	public native @Cast("MxResult") boolean StartActionIfUnknown0x13c(@ByRef MxDSAction p_dsAction);
...
@NoOffset public static class LegoModelPresenter extends MxVideoPresenter {
	...
	public native @Cast("MxResult") boolean CreateROI(@ByRef MxDSChunk p_chunk, LegoEntity p_entity, @Cast("MxBool") boolean p_roiVisible, LegoWorld p_world);
...
@NoOffset public static class LegoPartPresenter extends MxMediaPresenter {
	...
	public native void ReadyTickle();      // vtable+0x18
	public native @Cast("MxResult") boolean AddToManager(); // vtable+0x34
	...
	public native @Cast("MxResult") boolean Read(@ByRef MxDSChunk p_chunk);
...
public static class ColorOverride extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    ColorOverride(Pointer p) { super(p); }
    protected ColorOverride() { allocate(); }
    private native void allocate();
    public native @Cast("unsigned char") byte call(@Cast("const char*") BytePointer arg0, @Cast("char*") BytePointer arg1, @Cast("unsigned int") int arg2);
}
public static class TextureHandler extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    TextureHandler(Pointer p) { super(p); }
    protected TextureHandler() { allocate(); }
    private native void allocate();
    public native @Cast("unsigned char") byte call(@Cast("const char*") BytePointer arg0, @Cast("unsigned char*") BytePointer arg1, @Cast("unsigned int") int arg2);
}
@Opaque public static class LegoTextureInfo extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LegoTextureInfo() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoTextureInfo(Pointer p) { super(p); }
}
@Opaque public static class LegoAnim extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LegoAnim() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoAnim(Pointer p) { super(p); }
}
@Opaque public static class LegoAnimNodeData extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LegoAnimNodeData() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoAnimNodeData(Pointer p) { super(p); }
}
@Opaque public static class LegoTreeNode extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LegoTreeNode() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoTreeNode(Pointer p) { super(p); }
}
@Opaque public static class LegoAnimActorEntry extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LegoAnimActorEntry() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoAnimActorEntry(Pointer p) { super(p); }
}

// VTABLE: LEGO1 0x100dbe38
// VTABLE: BETA10 0x101c3898
// SIZE 0x108
@NoOffset public static class LegoROI extends ViewROI {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LegoROI(Pointer p) { super(p); }

	public LegoROI(Renderer p_renderer) { super((Pointer)null); allocate(p_renderer); }
	private native void allocate(Renderer p_renderer);
	public LegoROI(Renderer p_renderer, ViewLODList p_lodList) { super((Pointer)null); allocate(p_renderer, p_lodList); }
	private native void allocate(Renderer p_renderer, ViewLODList p_lodList);

	public native @ByVal LegoResult Read(
	...
	public native LegoROI FindChildROI(@Cast("const LegoChar*") char p_name, LegoROI p_roi);
	public native @ByVal LegoResult ApplyAnimationTransformation(
			LegoTreeNode p_node,
			@Const @ByRef Matrix4 p_matrix,
			@ByVal LegoTime p_time,
			LegoROI p_roi
		);
	public static native void FUN_100a8e80(LegoTreeNode p_node, @ByRef Matrix4 p_matrix, @ByVal LegoTime p_time, @Cast("LegoROI**") PointerPointer p_roiMap);
	public static native void FUN_100a8e80(LegoTreeNode p_node, @ByRef Matrix4 p_matrix, @ByVal LegoTime p_time, @ByPtrPtr LegoROI p_roiMap);
	public static native void FUN_100a8fd0(LegoTreeNode p_node, @ByRef Matrix4 p_matrix, @ByVal LegoTime p_time, @Cast("LegoROI**") PointerPointer p_roiMap);
	public static native void FUN_100a8fd0(LegoTreeNode p_node, @ByRef Matrix4 p_matrix, @ByVal LegoTime p_time, @ByPtrPtr LegoROI p_roiMap);
	public native @ByVal LegoResult SetFrame(LegoAnim p_anim, @ByVal LegoTime p_time);
	public native @ByVal LegoResult SetLodColor(@ByVal LegoFloat p_red, @ByVal LegoFloat p_green, @ByVal LegoFloat p_blue, @ByVal LegoFloat p_alpha);
	public native @ByVal LegoResult SetTextureInfo(LegoTextureInfo p_textureInfo);
	public native @ByVal LegoResult GetTextureInfo(@ByPtrRef LegoTextureInfo p_textureInfo);
	public native @ByVal LegoResult FUN_100a9330(@ByVal LegoFloat p_red, @ByVal LegoFloat p_green, @ByVal LegoFloat p_blue, @ByVal LegoFloat p_alpha);
	public native @ByVal LegoResult SetLodColor(@Cast("const LegoChar*") char p_name);
	public native @ByVal LegoResult FUN_100a93b0(@Cast("const LegoChar*") char p_name);
	public native @Cast("LegoU32") long FUN_100a9410(@ByRef Vector3 p_v1, @ByRef Vector3 p_v2, float p_f1, float p_f2, @ByRef Vector3 p_v3, @Cast("LegoBool") boolean p_collideBox);
	public native void SetName(@Cast("const LegoChar*") char p_name);

	public native float IntrinsicImportance(); // vtable+0x04
	public native void UpdateWorldBoundingVolumes(); // vtable+0x18

	public native void ClearMeshOffset();
	public native void SetDisplayBB(int p_displayBB);

	public static native @ByVal LegoResult CreateLocalTransform(LegoAnimNodeData p_data, @ByVal LegoTime p_time, @ByRef Matrix4 p_matrix);
	public static native void FUN_100a81b0(@Cast("const LegoChar*") char p_error);
	public static native void configureLegoROI(int p_roi);
	public static native void SetColorOverride(ColorOverride p_colorOverride);
	public static native @Cast("LegoBool") boolean GetRGBAColor(@Cast("const LegoChar*") char p_name, @ByRef FloatPointer p_red, @ByRef FloatPointer p_green, @ByRef FloatPointer p_blue, @ByRef FloatPointer p_alpha);
	public static native @Cast("LegoBool") boolean GetRGBAColor(@Cast("const LegoChar*") char p_name, @ByRef FloatBuffer p_red, @ByRef FloatBuffer p_green, @ByRef FloatBuffer p_blue, @ByRef FloatBuffer p_alpha);
	public static native @Cast("LegoBool") boolean GetRGBAColor(@Cast("const LegoChar*") char p_name, @ByRef float[] p_red, @ByRef float[] p_green, @ByRef float[] p_blue, @ByRef float[] p_alpha);
	public static native @Cast("LegoBool") boolean ColorAliasLookup(
			@Cast("const LegoChar*") char p_param,
			@ByRef FloatPointer p_red,
			@ByRef FloatPointer p_green,
			@ByRef FloatPointer p_blue,
			@ByRef FloatPointer p_alpha
		);
	public static native @Cast("LegoBool") boolean ColorAliasLookup(
			@Cast("const LegoChar*") char p_param,
			@ByRef FloatBuffer p_red,
			@ByRef FloatBuffer p_green,
			@ByRef FloatBuffer p_blue,
			@ByRef FloatBuffer p_alpha
		);
	public static native @Cast("LegoBool") boolean ColorAliasLookup(
			@Cast("const LegoChar*") char p_param,
			@ByRef float[] p_red,
	...
	public static native @Cast("LegoBool") boolean GetPaletteEntries(@Cast("const LegoChar*") char p_name, @Cast("unsigned char*") BytePointer paletteEntries, @Cast("LegoU32") long p_numEntries);
	public static native @Cast("LegoBool") boolean GetPaletteEntries(@Cast("const LegoChar*") char p_name, @Cast("unsigned char*") ByteBuffer paletteEntries, @Cast("LegoU32") long p_numEntries);
	public static native @Cast("LegoBool") boolean GetPaletteEntries(@Cast("const LegoChar*") char p_name, @Cast("unsigned char*") byte[] paletteEntries, @Cast("LegoU32") long p_numEntries);

	// FUNCTION: BETA10 0x1000f320
	public native @Cast("const LegoChar*") char GetName();

	// FUNCTION: BETA10 0x10015180
	public native LegoEntity GetEntity();

	public native @ByRef BoundingSphere GetBoundingSphere();

	// FUNCTION: BETA10 0x10013400
	public native void SetEntity(LegoEntity p_entity);

	public native void SetComp(CompoundObject p_comp);
	public native void SetBoundingSphere(@Const @ByRef BoundingSphere p_sphere);
	public native void SetBoundingBox(@Const @ByRef BoundingBox p_box);
}

// VTABLE: LEGO1 0x100dbea8
// VTABLE: BETA10 0x101c38d0
// SIZE 0x10c
@NoOffset public static class TimeROI extends LegoROI {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TimeROI(Pointer p) { super(p); }

	public TimeROI(Renderer p_renderer, ViewLODList p_lodList, @ByVal LegoTime p_time) { super((Pointer)null); allocate(p_renderer, p_lodList, p_time); }
	private native void allocate(Renderer p_renderer, ViewLODList p_lodList, @ByVal LegoTime p_time);

	public native void FUN_100a9b40(@ByRef Matrix4 p_matrix, @ByVal LegoTime p_time);
}
...
@NoOffset public static class LegoVideoManager extends MxVideoManager {
	...
	public native void SetCursorBitmap(@Const CursorBitmap p_cursorBitmap);
	public native void ToggleFPS(@Cast("MxBool") boolean p_visible);

	public native @Cast("MxResult") boolean Tickle();                                                                       // vtable+0x08
	public native void Destroy();                                                                          // vtable+0x18
	public native @Cast("MxResult") boolean Create(@ByRef MxVideoParam p_videoParam, @Cast("MxU32") long p_frequencyMS, @Cast("MxBool") boolean p_createThread); // vtable+0x2c
	public native @Cast("MxResult") boolean RealizePalette(MxPalette arg0);                                                     // vtable+0x30
	...
	public native @Cast("MxResult") boolean ResetPalette(@Cast("MxBool") boolean p_ignoreSkyColor);
...
@NoOffset public static class LegoWorldPresenter extends LegoEntityPresenter {
	...
	public native void ParseExtra();                                                            // vtable+0x30
	public native @Cast("MxResult") boolean StartAction(MxStreamController p_controller, MxDSAction p_action); // vtable+0x3c
	public native void VTable0x60(MxPresenter p_presenter);                                    // vtable+0x60

	public native @Cast("MxResult") boolean LoadWorld(@Cast("char*") BytePointer p_worldName, LegoWorld p_world);
	public native @Cast("MxResult") boolean LoadWorld(@Cast("char*") ByteBuffer p_worldName, LegoWorld p_world);
	public native @Cast("MxResult") boolean LoadWorld(@Cast("char*") byte[] p_worldName, LegoWorld p_world);
}
...
public static native @Cast("MxResult") boolean StartActionIfUnknown0x13c(@ByRef MxDSAction p_dsAction);
...
@NoOffset public static class MxBackgroundAudioManager extends MxCore {
	...
	public native @Cast("MxResult") boolean PlayMusic(@ByRef MxDSAction p_action, @Cast("MxS32") int p_speed, @ByVal TickleState p_tickleState);
	...
	public native @Cast("MxResult") boolean Create(@ByRef MxAtomId p_script, @Cast("MxU32") long p_frequencyMS);

	public native void Init();
	public native void Stop();
	public native void LowerVolume();
	public native void RaiseVolume();
	public native @Cast("MxResult") boolean SetPendingPresenter(MxPresenter p_presenter, @Cast("MxS32") int p_speed, @ByVal TickleState p_tickleState);
}
...
@NoOffset public static class MxCore extends Pointer {
	...
	public native @Cast("MxResult") boolean Tickle(); // vtable+08
...
@NoOffset public static class MxDirectDraw extends Pointer {
	...
	public static class ErrorHandler extends FunctionPointer {
	    ...
	    private native void allocate();
	    public native void call(@Cast("const char*") BytePointer arg0, @ByVal HRESULT arg1, Pointer arg2);
	}
	...
	public native @ByVal BOOL Create(
			@ByVal HWND hWnd,
			@ByVal BOOL fullscreen_1,
			@ByVal BOOL surface_fullscreen,
			@ByVal BOOL onlySystemMemory,
			int width,
			int height,
			int bpp,
	...
	public native Mode CurrentMode();

	// FUNCTION: BETA10 0x1011c170
	public native @ByVal BOOL IsFullScreen();

	public native int Pause(@ByVal BOOL arg0);
	public native @ByVal BOOL RestoreSurfaces();

	public native @Cast("const char*") BytePointer ErrorToString(@ByVal HRESULT p_error); // vtable+0x10
...
@NoOffset public static class MxDSAction extends MxDSObject {
	...
	public native @ByVal undefined4 VTable0x14();                            // vtable+0x14
...
// #endif
	...
	public native @Cast("MxResult") boolean Open(@Cast("MxULong") long arg0);                 // vtable+0x14
	public native @Cast("MxResult") boolean Close();                       // vtable+0x18
	public native @Cast("MxResult") boolean Read(@Cast("unsigned char*") BytePointer arg0, @Cast("MxULong") long arg1);
	public native @Cast("MxResult") boolean Read(@Cast("unsigned char*") ByteBuffer arg0, @Cast("MxULong") long arg1);
	public native @Cast("MxResult") boolean Read(@Cast("unsigned char*") byte[] arg0, @Cast("MxULong") long arg1); // vtable+0x20
	public native @Cast("MxResult") boolean Seek(@Cast("MxLong") long arg0, @ByVal SDL_IOWhence arg1);    // vtable+0x24
...
public static native @Cast("MxResult") boolean Start(MxDSAction arg0);
...
@NoOffset public static class MxOmniCreateParam extends MxParam {
	...
	public native @ByVal HWND GetWindowHandle();
...
@NoOffset public static class MxOmni extends MxCore {
	...
	public native void DeleteObject(@ByRef MxDSAction p_dsAction);                                        // vtable+0x24
	public native @Cast("MxBool") boolean DoesEntityExist(@ByRef MxDSAction p_dsAction);                                   // vtable+0x28
	public native @Cast("MxResult") boolean CreatePresenter(MxStreamController p_controller, @ByRef MxDSAction p_action); // vtable+0x2c
...
@NoOffset public static class MxStreamer extends MxCore {
	...
	public native @Cast("MxResult") boolean Create(); // vtable+0x14
	...
	public native @Cast("MxResult") boolean AddStreamControllerToOpenList(MxStreamController p_stream);
	public native @Cast("MxResult") boolean FUN_100b99b0(MxDSAction p_action);
	public native @Cast("MxResult") boolean DeleteObject(MxDSAction p_dsAction);
...
@NoOffset public static class MxTransitionManager extends MxCore {
	...
	public native @Cast("MxResult") boolean GetDDrawSurfaceFromVideoManager(); // vtable+0x14
	...
	public native @Cast("MxResult") boolean StartTransition(@Cast("MxTransitionManager::TransitionType") int p_animationType, @Cast("MxS32") int p_speed, @Cast("MxBool") boolean p_doCopy, @Cast("MxBool") boolean p_playMusicInAnim);
...
@NoOffset public static class MxMediaPresenter extends MxPresenter {
	...
	public native @Cast("MxResult") boolean StartAction(MxStreamController arg0, MxDSAction arg1); // vtable+0x3c
...
public static class FlagBitfield extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public FlagBitfield() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FlagBitfield(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FlagBitfield(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public FlagBitfield position(long position) {
        return (FlagBitfield)super.position(position);
    }
    @Override public FlagBitfield getPointer(long i) {
        return new FlagBitfield((Pointer)this).offsetAddress(i);
    }

		public native @Cast("MxU8") @NoOffset short m_bit0(); public native FlagBitfield m_bit0(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit1(); public native FlagBitfield m_bit1(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit2(); public native FlagBitfield m_bit2(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit3(); public native FlagBitfield m_bit3(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit4(); public native FlagBitfield m_bit4(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit5(); public native FlagBitfield m_bit5(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit6(); public native FlagBitfield m_bit6(short setter);
		public native @Cast("MxU8") @NoOffset short m_bit7(); public native FlagBitfield m_bit7(short setter);
	// BYTE all; // ?
}
...
// SIZE 0xdc
@NoOffset public static class OrientableROI extends ROI {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public OrientableROI(Pointer p) { super(p); }
	...
	public native @Const FloatPointer GetWorldVelocity();                // vtable+0x08
	public native @Const @ByRef BoundingBox GetWorldBoundingBox();       // vtable+0x0c
	public native @Const @ByRef BoundingSphere GetWorldBoundingSphere(); // vtable+0x10

	// FUNCTION: LEGO1 0x100a5db0
	// FUNCTION: BETA10 0x101687d0
	public native void WrappedUpdateWorldData(); // vtable+0x14

	public native void UpdateWorldBoundingVolumes();                                    // vtable+0x18
	public native void UpdateWorldData();                                                   // vtable+0x1c
	public native void SetLocal2WorldWithWorldDataUpdate(@Const @ByRef Matrix4 p_local2world);     // vtable+0x20
	public native void UpdateWorldDataWithTransform(@Const @ByRef Matrix4 p_transform);            // vtable+0x24
	public native void UpdateWorldDataWithTransformAndChildren(@Const @ByRef Matrix4 p_transform); // vtable+0x28
	public native void UpdateWorldVelocity();                                               // vtable+0x2c

	public native void WrappedSetLocal2WorldWithWorldDataUpdate(@Const @ByRef Matrix4 p_local2world);
	public native void UpdateTransformationRelativeToParent(@Const @ByRef Matrix4 p_transform);
	public native void WrappedUpdateWorldDataWithTransform(@Const @ByRef Matrix4 p_transform);
	public native void GetLocalTransform(@ByRef Matrix4 p_transform);
	public native void SetLocal2World(@Const @ByRef Matrix4 p_local2world);
	public native void SetWorldVelocity(@Const @ByRef Vector3 p_world_velocity);

	// FUNCTION: BETA10 0x1000fbf0
	public native @Const @ByRef Matrix4 GetLocal2World();

	// FUNCTION: BETA10 0x10011750
	public native @Const FloatPointer GetWorldPosition();

	// FUNCTION: BETA10 0x10011780
	public native @Const FloatPointer GetWorldDirection();

	// FUNCTION: BETA10 0x1004aa70
	public native @Const FloatPointer GetWorldUp();

	// FUNCTION: BETA10 0x10070380
	public native OrientableROI GetParentROI();

	public native void SetParentROI(OrientableROI p_parentROI);

	// FUNCTION: BETA10 0x10168800
	public native void SetNeedsWorldDataUpdate(@ByVal BOOL p_needsWorldDataUpdate);
}
...
// SIZE 0xe4
@NoOffset public static class ViewROI extends OrientableROI {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
